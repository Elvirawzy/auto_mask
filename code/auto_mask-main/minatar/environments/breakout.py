...
class Env:
    def __init__(self, ramping=None):
        ...
        self.action_map = ['n','l', 'r'] + ['r' for _ in range(97)]
    ...
    def reset(self):
        self.ball_y = 3
        ball_start = self.random.randint(10)
        start_pos = [(i, j) for i in range(3, 7) for j in range(2, 4)] + [(0,2),(9,3)]
        self.ball_x, self.ball_dir = start_pos[ball_start]
        self.pos = 4
