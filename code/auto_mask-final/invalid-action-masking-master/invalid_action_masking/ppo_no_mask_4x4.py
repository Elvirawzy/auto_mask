...
if __name__ == "__main__":
    ...
    parser.add_argument('--invalid-action-penalty', type=float, default=0,
...
experiment_name = f"{args.gym_id}__{args.exp_name}__{args.invalid_action_penalty}__{int(time.time())}"
